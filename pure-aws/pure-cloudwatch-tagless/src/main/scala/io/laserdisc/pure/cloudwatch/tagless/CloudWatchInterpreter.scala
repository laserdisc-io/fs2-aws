...
object CloudWatchInterpreter {

  def apply[M[_]](
      implicit am: Async[M]
  ): CloudWatchInterpreter[M] =
    new CloudWatchInterpreter[M] {
...
trait CloudWatchInterpreter[M[_]] { outer =>
  ...
  trait CloudWatchAsyncClientInterpreter extends CloudWatchAsyncClientOp[Kleisli[M, CloudWatchAsyncClient, *]] {
    ...
    override def deleteAnomalyDetector(
        a: DeleteAnomalyDetectorRequest
    ): Kleisli[M, CloudWatchAsyncClient, DeleteAnomalyDetectorResponse] = eff(_.deleteAnomalyDetector(a))
    override def deleteDashboards(
        a: DeleteDashboardsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DeleteDashboardsResponse] = eff(_.deleteDashboards(a))
    override def deleteInsightRules(
        a: DeleteInsightRulesRequest
    ): Kleisli[M, CloudWatchAsyncClient, DeleteInsightRulesResponse] = eff(_.deleteInsightRules(a))
    override def deleteMetricStream(
        a: DeleteMetricStreamRequest
    ): Kleisli[M, CloudWatchAsyncClient, DeleteMetricStreamResponse] = eff(_.deleteMetricStream(a))
    override def describeAlarmContributors(
        a: DescribeAlarmContributorsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmContributorsResponse] = eff(_.describeAlarmContributors(a))
    override def describeAlarmHistory: Kleisli[M, CloudWatchAsyncClient, DescribeAlarmHistoryResponse] = eff(
      _.describeAlarmHistory
    )
    override def describeAlarmHistory(
        a: DescribeAlarmHistoryRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmHistoryResponse] = eff(_.describeAlarmHistory(a))
    override def describeAlarmHistoryPaginator: Kleisli[M, CloudWatchAsyncClient, DescribeAlarmHistoryPublisher] =
      primitive(_.describeAlarmHistoryPaginator)
    override def describeAlarmHistoryPaginator(
        a: DescribeAlarmHistoryRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmHistoryPublisher] = primitive(_.describeAlarmHistoryPaginator(a))
    override def describeAlarms: Kleisli[M, CloudWatchAsyncClient, DescribeAlarmsResponse] = eff(_.describeAlarms)
    override def describeAlarms(a: DescribeAlarmsRequest): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmsResponse] =
      eff(_.describeAlarms(a))
    override def describeAlarmsForMetric(
        a: DescribeAlarmsForMetricRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmsForMetricResponse] = eff(_.describeAlarmsForMetric(a))
    override def describeAlarmsPaginator: Kleisli[M, CloudWatchAsyncClient, DescribeAlarmsPublisher] = primitive(
      _.describeAlarmsPaginator
    )
    override def describeAlarmsPaginator(
        a: DescribeAlarmsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAlarmsPublisher] = primitive(_.describeAlarmsPaginator(a))
    override def describeAnomalyDetectors(
        a: DescribeAnomalyDetectorsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAnomalyDetectorsResponse] = eff(_.describeAnomalyDetectors(a))
    override def describeAnomalyDetectorsPaginator(
        a: DescribeAnomalyDetectorsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeAnomalyDetectorsPublisher] = primitive(
      _.describeAnomalyDetectorsPaginator(a)
    )
    override def describeInsightRules(
        a: DescribeInsightRulesRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeInsightRulesResponse] = eff(_.describeInsightRules(a))
    override def describeInsightRulesPaginator(
        a: DescribeInsightRulesRequest
    ): Kleisli[M, CloudWatchAsyncClient, DescribeInsightRulesPublisher] = primitive(_.describeInsightRulesPaginator(a))
    override def disableAlarmActions(
        a: DisableAlarmActionsRequest
    ): Kleisli[M, CloudWatchAsyncClient, DisableAlarmActionsResponse] = eff(_.disableAlarmActions(a))
    ...
    ): Kleisli[M, CloudWatchAsyncClient, GetInsightRuleReportResponse] = eff(_.getInsightRuleReport(a))
    override def getMetricData(a: GetMetricDataRequest): Kleisli[M, CloudWatchAsyncClient, GetMetricDataResponse] = eff(
      _.getMetricData(a)
    )
    override def getMetricDataPaginator(
        a: GetMetricDataRequest
    ): Kleisli[M, CloudWatchAsyncClient, GetMetricDataPublisher] = primitive(_.getMetricDataPaginator(a))
    override def getMetricStatistics(
        a: GetMetricStatisticsRequest
    ): Kleisli[M, CloudWatchAsyncClient, GetMetricStatisticsResponse] = eff(_.getMetricStatistics(a))
    override def getMetricStream(
        a: GetMetricStreamRequest
    ): Kleisli[M, CloudWatchAsyncClient, GetMetricStreamResponse] = eff(_.getMetricStream(a))
    ...
    override def listDashboardsPaginator: Kleisli[M, CloudWatchAsyncClient, ListDashboardsPublisher] = primitive(
      _.listDashboardsPaginator
    )
    override def listDashboardsPaginator(
        a: ListDashboardsRequest
    ): Kleisli[M, CloudWatchAsyncClient, ListDashboardsPublisher] = primitive(_.listDashboardsPaginator(a))
    override def listManagedInsightRules(
        a: ListManagedInsightRulesRequest
    ): Kleisli[M, CloudWatchAsyncClient, ListManagedInsightRulesResponse] = eff(_.listManagedInsightRules(a))
    override def listManagedInsightRulesPaginator(
        a: ListManagedInsightRulesRequest
    ): Kleisli[M, CloudWatchAsyncClient, ListManagedInsightRulesPublisher] = primitive(
      _.listManagedInsightRulesPaginator(a)
    )
    override def listMetricStreams(
        a: ListMetricStreamsRequest
    ): Kleisli[M, CloudWatchAsyncClient, ListMetricStreamsResponse] = eff(_.listMetricStreams(a))
    override def listMetricStreamsPaginator(
        a: ListMetricStreamsRequest
    ): Kleisli[M, CloudWatchAsyncClient, ListMetricStreamsPublisher] = primitive(_.listMetricStreamsPaginator(a))
    override def listMetrics: Kleisli[M, CloudWatchAsyncClient, ListMetricsResponse] = eff(_.listMetrics)
    override def listMetrics(a: ListMetricsRequest): Kleisli[M, CloudWatchAsyncClient, ListMetricsResponse] = eff(
      _.listMetrics(a)
    )
    override def listMetricsPaginator: Kleisli[M, CloudWatchAsyncClient, ListMetricsPublisher] = primitive(
      _.listMetricsPaginator
    )
    override def listMetricsPaginator(a: ListMetricsRequest): Kleisli[M, CloudWatchAsyncClient, ListMetricsPublisher] =
      primitive(_.listMetricsPaginator(a))
    ...
    override def putCompositeAlarm(
        a: PutCompositeAlarmRequest
    ): Kleisli[M, CloudWatchAsyncClient, PutCompositeAlarmResponse] = eff(_.putCompositeAlarm(a))
    override def putDashboard(a: PutDashboardRequest): Kleisli[M, CloudWatchAsyncClient, PutDashboardResponse] = eff(
      _.putDashboard(a)
    )
    ...
    override def putMetricAlarm(a: PutMetricAlarmRequest): Kleisli[M, CloudWatchAsyncClient, PutMetricAlarmResponse] =
      eff(_.putMetricAlarm(a))
    override def putMetricData(a: PutMetricDataRequest): Kleisli[M, CloudWatchAsyncClient, PutMetricDataResponse] = eff(
      _.putMetricData(a)
    )
    override def putMetricStream(
        a: PutMetricStreamRequest
    ): Kleisli[M, CloudWatchAsyncClient, PutMetricStreamResponse] = eff(_.putMetricStream(a))
    override def serviceClientConfiguration: Kleisli[M, CloudWatchAsyncClient, CloudWatchServiceClientConfiguration] =
    ...
    override def setAlarmState(a: SetAlarmStateRequest): Kleisli[M, CloudWatchAsyncClient, SetAlarmStateResponse] = eff(
      _.setAlarmState(a)
    )
    ...
    override def untagResource(a: UntagResourceRequest): Kleisli[M, CloudWatchAsyncClient, UntagResourceResponse] = eff(
      _.untagResource(a)
    )
    ...
    def lens[E](f: E => CloudWatchAsyncClient): CloudWatchAsyncClientOp[Kleisli[M, E, *]] =
      new CloudWatchAsyncClientOp[Kleisli[M, E, *]] {
        ...
        override def deleteAnomalyDetector(
            a: DeleteAnomalyDetectorRequest
        ): Kleisli[M, E, DeleteAnomalyDetectorResponse] = Kleisli(e => eff1(f(e).deleteAnomalyDetector(a)))
        override def deleteDashboards(a: DeleteDashboardsRequest): Kleisli[M, E, DeleteDashboardsResponse] =
          Kleisli(e => eff1(f(e).deleteDashboards(a)))
        override def deleteInsightRules(a: DeleteInsightRulesRequest): Kleisli[M, E, DeleteInsightRulesResponse] =
          Kleisli(e => eff1(f(e).deleteInsightRules(a)))
        override def deleteMetricStream(a: DeleteMetricStreamRequest): Kleisli[M, E, DeleteMetricStreamResponse] =
          Kleisli(e => eff1(f(e).deleteMetricStream(a)))
        override def describeAlarmContributors(
            a: DescribeAlarmContributorsRequest
        ): Kleisli[M, E, DescribeAlarmContributorsResponse] = Kleisli(e => eff1(f(e).describeAlarmContributors(a)))
        override def describeAlarmHistory: Kleisli[M, E, DescribeAlarmHistoryResponse] =
          Kleisli(e => eff1(f(e).describeAlarmHistory))
        override def describeAlarmHistory(a: DescribeAlarmHistoryRequest): Kleisli[M, E, DescribeAlarmHistoryResponse] =
          Kleisli(e => eff1(f(e).describeAlarmHistory(a)))
        override def describeAlarmHistoryPaginator: Kleisli[M, E, DescribeAlarmHistoryPublisher] =
          Kleisli(e => primitive1(f(e).describeAlarmHistoryPaginator))
        override def describeAlarmHistoryPaginator(
            a: DescribeAlarmHistoryRequest
        ): Kleisli[M, E, DescribeAlarmHistoryPublisher] =
        ...
        override def describeAlarms(a: DescribeAlarmsRequest): Kleisli[M, E, DescribeAlarmsResponse] =
          Kleisli(e => eff1(f(e).describeAlarms(a)))
        override def describeAlarmsForMetric(
            a: DescribeAlarmsForMetricRequest
        ): Kleisli[M, E, DescribeAlarmsForMetricResponse] = Kleisli(e => eff1(f(e).describeAlarmsForMetric(a)))
        override def describeAlarmsPaginator: Kleisli[M, E, DescribeAlarmsPublisher] =
          Kleisli(e => primitive1(f(e).describeAlarmsPaginator))
        override def describeAlarmsPaginator(a: DescribeAlarmsRequest): Kleisli[M, E, DescribeAlarmsPublisher] =
          Kleisli(e => primitive1(f(e).describeAlarmsPaginator(a)))
        override def describeAnomalyDetectors(
            a: DescribeAnomalyDetectorsRequest
        ): Kleisli[M, E, DescribeAnomalyDetectorsResponse] = Kleisli(e => eff1(f(e).describeAnomalyDetectors(a)))
        override def describeAnomalyDetectorsPaginator(
            a: DescribeAnomalyDetectorsRequest
        ): Kleisli[M, E, DescribeAnomalyDetectorsPublisher] =
          Kleisli(e => primitive1(f(e).describeAnomalyDetectorsPaginator(a)))
        override def describeInsightRules(a: DescribeInsightRulesRequest): Kleisli[M, E, DescribeInsightRulesResponse] =
          Kleisli(e => eff1(f(e).describeInsightRules(a)))
        override def describeInsightRulesPaginator(
            a: DescribeInsightRulesRequest
        ): Kleisli[M, E, DescribeInsightRulesPublisher] =
          Kleisli(e => primitive1(f(e).describeInsightRulesPaginator(a)))
        override def disableAlarmActions(a: DisableAlarmActionsRequest): Kleisli[M, E, DisableAlarmActionsResponse] =
        ...
        override def getMetricDataPaginator(a: GetMetricDataRequest): Kleisli[M, E, GetMetricDataPublisher] =
          Kleisli(e => primitive1(f(e).getMetricDataPaginator(a)))
        override def getMetricStatistics(a: GetMetricStatisticsRequest): Kleisli[M, E, GetMetricStatisticsResponse] =
          Kleisli(e => eff1(f(e).getMetricStatistics(a)))
        override def getMetricStream(a: GetMetricStreamRequest): Kleisli[M, E, GetMetricStreamResponse] =
        ...
        override def listDashboardsPaginator: Kleisli[M, E, ListDashboardsPublisher] =
          Kleisli(e => primitive1(f(e).listDashboardsPaginator))
        override def listDashboardsPaginator(a: ListDashboardsRequest): Kleisli[M, E, ListDashboardsPublisher] =
          Kleisli(e => primitive1(f(e).listDashboardsPaginator(a)))
        override def listManagedInsightRules(
            a: ListManagedInsightRulesRequest
        ): Kleisli[M, E, ListManagedInsightRulesResponse] = Kleisli(e => eff1(f(e).listManagedInsightRules(a)))
        override def listManagedInsightRulesPaginator(
            a: ListManagedInsightRulesRequest
        ): Kleisli[M, E, ListManagedInsightRulesPublisher] =
          Kleisli(e => primitive1(f(e).listManagedInsightRulesPaginator(a)))
        override def listMetricStreams(a: ListMetricStreamsRequest): Kleisli[M, E, ListMetricStreamsResponse] =
          Kleisli(e => eff1(f(e).listMetricStreams(a)))
        override def listMetricStreamsPaginator(
            a: ListMetricStreamsRequest
        ): Kleisli[M, E, ListMetricStreamsPublisher] = Kleisli(e => primitive1(f(e).listMetricStreamsPaginator(a)))
        override def listMetrics: Kleisli[M, E, ListMetricsResponse] = Kleisli(e => eff1(f(e).listMetrics))
        override def listMetrics(a: ListMetricsRequest): Kleisli[M, E, ListMetricsResponse] =
          Kleisli(e => eff1(f(e).listMetrics(a)))
        override def listMetricsPaginator: Kleisli[M, E, ListMetricsPublisher] =
          Kleisli(e => primitive1(f(e).listMetricsPaginator))
        override def listMetricsPaginator(a: ListMetricsRequest): Kleisli[M, E, ListMetricsPublisher] =
        ...
        override def putDashboard(a: PutDashboardRequest): Kleisli[M, E, PutDashboardResponse] =
        ...
        override def putMetricAlarm(a: PutMetricAlarmRequest): Kleisli[M, E, PutMetricAlarmResponse] =
          Kleisli(e => eff1(f(e).putMetricAlarm(a)))
        override def putMetricData(a: PutMetricDataRequest): Kleisli[M, E, PutMetricDataResponse] =
          Kleisli(e => eff1(f(e).putMetricData(a)))
        override def putMetricStream(a: PutMetricStreamRequest): Kleisli[M, E, PutMetricStreamResponse] =
          Kleisli(e => eff1(f(e).putMetricStream(a)))
        override def serviceClientConfiguration: Kleisli[M, E, CloudWatchServiceClientConfiguration] =
        ...
        override def setAlarmState(a: SetAlarmStateRequest): Kleisli[M, E, SetAlarmStateResponse] =
  ...
  def clientResource: Resource[M, CloudWatchAsyncClient] = clientResource(CloudWatchAsyncClient.builder())
  ...
  def create(client: CloudWatchAsyncClient): CloudWatchAsyncClientOp[M] = new CloudWatchAsyncClientOp[M] {
    ...
    override def deleteDashboards(a: DeleteDashboardsRequest): M[DeleteDashboardsResponse] = eff1(
      client.deleteDashboards(a)
    )
    override def deleteInsightRules(a: DeleteInsightRulesRequest): M[DeleteInsightRulesResponse] = eff1(
      client.deleteInsightRules(a)
    )
    override def deleteMetricStream(a: DeleteMetricStreamRequest): M[DeleteMetricStreamResponse] = eff1(
      client.deleteMetricStream(a)
    )
    override def describeAlarmContributors(a: DescribeAlarmContributorsRequest): M[DescribeAlarmContributorsResponse] =
      eff1(client.describeAlarmContributors(a))
    override def describeAlarmHistory: M[DescribeAlarmHistoryResponse] = eff1(client.describeAlarmHistory)
    override def describeAlarmHistory(a: DescribeAlarmHistoryRequest): M[DescribeAlarmHistoryResponse] = eff1(
      client.describeAlarmHistory(a)
    )
    override def describeAlarmHistoryPaginator: M[DescribeAlarmHistoryPublisher] = primitive1(
      client.describeAlarmHistoryPaginator
    )
    override def describeAlarmHistoryPaginator(a: DescribeAlarmHistoryRequest): M[DescribeAlarmHistoryPublisher] =
    ...
    override def describeAlarmsForMetric(a: DescribeAlarmsForMetricRequest): M[DescribeAlarmsForMetricResponse] = eff1(
      client.describeAlarmsForMetric(a)
    )
    override def describeAlarmsPaginator: M[DescribeAlarmsPublisher] = primitive1(client.describeAlarmsPaginator)
    override def describeAlarmsPaginator(a: DescribeAlarmsRequest): M[DescribeAlarmsPublisher] = primitive1(
      client.describeAlarmsPaginator(a)
    )
    override def describeAnomalyDetectors(a: DescribeAnomalyDetectorsRequest): M[DescribeAnomalyDetectorsResponse] =
      eff1(client.describeAnomalyDetectors(a))
    override def describeAnomalyDetectorsPaginator(
        a: DescribeAnomalyDetectorsRequest
    ): M[DescribeAnomalyDetectorsPublisher] = primitive1(client.describeAnomalyDetectorsPaginator(a))
    override def describeInsightRules(a: DescribeInsightRulesRequest): M[DescribeInsightRulesResponse] = eff1(
      client.describeInsightRules(a)
    )
    override def describeInsightRulesPaginator(a: DescribeInsightRulesRequest): M[DescribeInsightRulesPublisher] =
      primitive1(client.describeInsightRulesPaginator(a))
    override def disableAlarmActions(a: DisableAlarmActionsRequest): M[DisableAlarmActionsResponse] = eff1(
      client.disableAlarmActions(a)
    )
    ...
    override def getMetricDataPaginator(a: GetMetricDataRequest): M[GetMetricDataPublisher] = primitive1(
      client.getMetricDataPaginator(a)
    )
    override def getMetricStatistics(a: GetMetricStatisticsRequest): M[GetMetricStatisticsResponse] = eff1(
      client.getMetricStatistics(a)
    )
    override def getMetricStream(a: GetMetricStreamRequest): M[GetMetricStreamResponse] = eff1(
      client.getMetricStream(a)
    )
    ...
    override def listDashboardsPaginator(a: ListDashboardsRequest): M[ListDashboardsPublisher] = primitive1(
      client.listDashboardsPaginator(a)
    )
    override def listManagedInsightRules(a: ListManagedInsightRulesRequest): M[ListManagedInsightRulesResponse] = eff1(
      client.listManagedInsightRules(a)
    )
    override def listManagedInsightRulesPaginator(
        a: ListManagedInsightRulesRequest
    ): M[ListManagedInsightRulesPublisher] = primitive1(client.listManagedInsightRulesPaginator(a))
    override def listMetricStreams(a: ListMetricStreamsRequest): M[ListMetricStreamsResponse] = eff1(
      client.listMetricStreams(a)
    )
    override def listMetricStreamsPaginator(a: ListMetricStreamsRequest): M[ListMetricStreamsPublisher] = primitive1(
    ...
    override def listMetricsPaginator(a: ListMetricsRequest): M[ListMetricsPublisher] = primitive1(
      client.listMetricsPaginator(a)
    )
    ...
    override def putCompositeAlarm(a: PutCompositeAlarmRequest): M[PutCompositeAlarmResponse] = eff1(
      client.putCompositeAlarm(a)
    )
    ...
    override def putMetricStream(a: PutMetricStreamRequest): M[PutMetricStreamResponse] = eff1(
      client.putMetricStream(a)
    )
    override def serviceClientConfiguration: M[CloudWatchServiceClientConfiguration] = primitive1(
