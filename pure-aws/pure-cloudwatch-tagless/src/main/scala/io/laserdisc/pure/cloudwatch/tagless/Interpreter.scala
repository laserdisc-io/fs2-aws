...
trait Interpreter[M[_]] { outer =>
  ...
  trait CloudWatchAsyncClientInterpreter
    ...
    override def deleteAnomalyDetector(a: DeleteAnomalyDetectorRequest) = eff(
      _.deleteAnomalyDetector(a)
    )
    ...
    override def describeAlarmHistory(a: DescribeAlarmHistoryRequest) = eff(
      _.describeAlarmHistory(a)
    )
    ...
    override def describeAlarmsForMetric(a: DescribeAlarmsForMetricRequest) = eff(
      _.describeAlarmsForMetric(a)
    )
    override def describeAlarmsPaginator = primitive(_.describeAlarmsPaginator)
    override def describeAlarmsPaginator(a: DescribeAlarmsRequest) = primitive(
      _.describeAlarmsPaginator(a)
    )
    override def describeAnomalyDetectors(a: DescribeAnomalyDetectorsRequest) = eff(
      _.describeAnomalyDetectors(a)
    )
    override def describeInsightRules(a: DescribeInsightRulesRequest) = eff(
      _.describeInsightRules(a)
    )
    ...
    override def getInsightRuleReport(a: GetInsightRuleReportRequest) = eff(
      _.getInsightRuleReport(a)
    )
    override def getMetricData(a: GetMetricDataRequest) = eff(_.getMetricData(a))
    override def getMetricDataPaginator(a: GetMetricDataRequest) = primitive(
      _.getMetricDataPaginator(a)
    )
    ...
    override def getMetricWidgetImage(a: GetMetricWidgetImageRequest) = eff(
      _.getMetricWidgetImage(a)
    )
    ...
    override def listDashboardsPaginator(a: ListDashboardsRequest) = primitive(
      _.listDashboardsPaginator(a)
    )
    override def listMetricStreams(a: ListMetricStreamsRequest) = eff(_.listMetricStreams(a))
    override def listMetricStreamsPaginator(a: ListMetricStreamsRequest) = primitive(
      _.listMetricStreamsPaginator(a)
    )
  ...
  def create(client: CloudWatchAsyncClient): CloudWatchAsyncClientOp[M] =
    new CloudWatchAsyncClientOp[M] {
      ...
      override def deleteAnomalyDetector(a: DeleteAnomalyDetectorRequest) = eff1(
        client.deleteAnomalyDetector(a)
      )
      override def deleteDashboards(a: DeleteDashboardsRequest) = eff1(client.deleteDashboards(a))
      override def deleteInsightRules(a: DeleteInsightRulesRequest) = eff1(
        client.deleteInsightRules(a)
      )
      override def deleteMetricStream(a: DeleteMetricStreamRequest) = eff1(
        client.deleteMetricStream(a)
      )
      override def describeAlarmHistory = eff1(client.describeAlarmHistory)
      override def describeAlarmHistory(a: DescribeAlarmHistoryRequest) = eff1(
      ...
      override def describeAlarmsForMetric(a: DescribeAlarmsForMetricRequest) = eff1(
        client.describeAlarmsForMetric(a)
      )
      override def describeAlarmsPaginator = primitive1(client.describeAlarmsPaginator)
      override def describeAlarmsPaginator(a: DescribeAlarmsRequest) = primitive1(
        client.describeAlarmsPaginator(a)
      )
      override def describeAnomalyDetectors(a: DescribeAnomalyDetectorsRequest) = eff1(
        client.describeAnomalyDetectors(a)
      )
      override def describeInsightRules(a: DescribeInsightRulesRequest) = eff1(
        client.describeInsightRules(a)
      )
      override def describeInsightRulesPaginator(a: DescribeInsightRulesRequest) =
        primitive1(client.describeInsightRulesPaginator(a))
      override def disableAlarmActions(a: DisableAlarmActionsRequest) = eff1(
        client.disableAlarmActions(a)
      )
      override def disableInsightRules(a: DisableInsightRulesRequest) = eff1(
        client.disableInsightRules(a)
      )
      override def enableAlarmActions(a: EnableAlarmActionsRequest) = eff1(
        client.enableAlarmActions(a)
      )
      override def enableInsightRules(a: EnableInsightRulesRequest) = eff1(
        client.enableInsightRules(a)
      )
      override def getDashboard(a: GetDashboardRequest) = eff1(client.getDashboard(a))
      override def getInsightRuleReport(a: GetInsightRuleReportRequest) = eff1(
        client.getInsightRuleReport(a)
      )
      override def getMetricData(a: GetMetricDataRequest) = eff1(client.getMetricData(a))
      override def getMetricDataPaginator(a: GetMetricDataRequest) = primitive1(
        client.getMetricDataPaginator(a)
      )
      override def getMetricStatistics(a: GetMetricStatisticsRequest) = eff1(
        client.getMetricStatistics(a)
      )
      override def getMetricStream(a: GetMetricStreamRequest) = eff1(client.getMetricStream(a))
      override def getMetricWidgetImage(a: GetMetricWidgetImageRequest) = eff1(
      ...
      override def listDashboardsPaginator(a: ListDashboardsRequest) = primitive1(
        client.listDashboardsPaginator(a)
      )
      override def listMetricStreams(a: ListMetricStreamsRequest) = eff1(
      ...
      override def listMetricsPaginator(a: ListMetricsRequest) = primitive1(
        client.listMetricsPaginator(a)
      )
      override def listTagsForResource(a: ListTagsForResourceRequest) = eff1(
        client.listTagsForResource(a)
      )
      override def putAnomalyDetector(a: PutAnomalyDetectorRequest) = eff1(
        client.putAnomalyDetector(a)
      )
      override def putCompositeAlarm(a: PutCompositeAlarmRequest) = eff1(
      ...
      override def startMetricStreams(a: StartMetricStreamsRequest) = eff1(
        client.startMetricStreams(a)
      )
      override def stopMetricStreams(a: StopMetricStreamsRequest) = eff1(
