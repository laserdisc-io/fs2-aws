...
trait Interpreter[M[_]] { outer =>
  ...
  trait DynamoDbAsyncClientInterpreter extends DynamoDbAsyncClientOp[Kleisli[M, DynamoDbAsyncClient, *]] {
    ...
    override def batchExecuteStatement(a: BatchExecuteStatementRequest)         = eff(_.batchExecuteStatement(a))
    override def batchGetItem(a: BatchGetItemRequest)                           = eff(_.batchGetItem(a))
    override def batchGetItemPaginator(a: BatchGetItemRequest)                  = primitive(_.batchGetItemPaginator(a))
    ...
    override def disableKinesisStreamingDestination(a: DisableKinesisStreamingDestinationRequest) = eff(
      _.disableKinesisStreamingDestination(a)
    )
    override def enableKinesisStreamingDestination(a: EnableKinesisStreamingDestinationRequest) = eff(
    ...
    override def listContributorInsightsPaginator(a: ListContributorInsightsRequest) = primitive(
  ...
  def create(client: DynamoDbAsyncClient): DynamoDbAsyncClientOp[M] = new DynamoDbAsyncClientOp[M] {
    ...
    override def describeContinuousBackups(a: DescribeContinuousBackupsRequest) = eff1(
      client.describeContinuousBackups(a)
    )
    override def describeContributorInsights(a: DescribeContributorInsightsRequest) = eff1(
      client.describeContributorInsights(a)
    )
    ...
    override def describeTableReplicaAutoScaling(a: DescribeTableReplicaAutoScalingRequest) = eff1(
      client.describeTableReplicaAutoScaling(a)
    )
    override def describeTimeToLive(a: DescribeTimeToLiveRequest) = eff1(client.describeTimeToLive(a))
    override def disableKinesisStreamingDestination(a: DisableKinesisStreamingDestinationRequest) = eff1(
      client.disableKinesisStreamingDestination(a)
    )
    override def enableKinesisStreamingDestination(a: EnableKinesisStreamingDestinationRequest) = eff1(
      client.enableKinesisStreamingDestination(a)
    )
    ...
    override def listContributorInsightsPaginator(a: ListContributorInsightsRequest) = primitive1(
      client.listContributorInsightsPaginator(a)
    )
