...
trait Interpreter[M[_]] { outer =>
  ...
  trait DynamoDbAsyncClientInterpreter
    ...
    override def batchExecuteStatement(a: BatchExecuteStatementRequest) = eff(
      _.batchExecuteStatement(a)
    )
    override def batchGetItem(a: BatchGetItemRequest) = eff(_.batchGetItem(a))
    override def batchGetItemPaginator(a: BatchGetItemRequest) = primitive(
      _.batchGetItemPaginator(a)
    )
    ...
    override def describeContinuousBackups(a: DescribeContinuousBackupsRequest) = eff(
      _.describeContinuousBackups(a)
    )
    ...
    override def exportTableToPointInTime(a: ExportTableToPointInTimeRequest) = eff(
      _.exportTableToPointInTime(a)
    )
    ...
    override def listContributorInsights(a: ListContributorInsightsRequest) = eff(
      _.listContributorInsights(a)
    )
    ...
    override def restoreTableFromBackup(a: RestoreTableFromBackupRequest) = eff(
      _.restoreTableFromBackup(a)
    )
    override def restoreTableToPointInTime(a: RestoreTableToPointInTimeRequest) = eff(
      _.restoreTableToPointInTime(a)
    )
    ...
    override def updateContinuousBackups(a: UpdateContinuousBackupsRequest) = eff(
      _.updateContinuousBackups(a)
    )
    override def updateContributorInsights(a: UpdateContributorInsightsRequest) = eff(
      _.updateContributorInsights(a)
    )
    override def updateGlobalTable(a: UpdateGlobalTableRequest) = eff(_.updateGlobalTable(a))
    override def updateGlobalTableSettings(a: UpdateGlobalTableSettingsRequest) = eff(
      _.updateGlobalTableSettings(a)
    )
  ...
  def create(client: DynamoDbAsyncClient): DynamoDbAsyncClientOp[M] = new DynamoDbAsyncClientOp[M] {
    ...
    // domain-specific operations are implemented in terms of `primitive`
    override def batchExecuteStatement(a: BatchExecuteStatementRequest) = eff1(
      client.batchExecuteStatement(a)
    )
    override def batchGetItem(a: BatchGetItemRequest) = eff1(client.batchGetItem(a))
    override def batchGetItemPaginator(a: BatchGetItemRequest) = primitive1(
    ...
    override def describeGlobalTable(a: DescribeGlobalTableRequest) = eff1(
    ...
    override def describeTimeToLive(a: DescribeTimeToLiveRequest) = eff1(
    ...
    override def executeTransaction(a: ExecuteTransactionRequest) = eff1(
      client.executeTransaction(a)
    )
    override def exportTableToPointInTime(a: ExportTableToPointInTimeRequest) = eff1(
      client.exportTableToPointInTime(a)
    )
    ...
    override def listContributorInsights(a: ListContributorInsightsRequest) = eff1(
    ...
    override def listExportsPaginator(a: ListExportsRequest) = primitive1(
    ...
    override def listTablesPaginator(a: ListTablesRequest) = primitive1(
      client.listTablesPaginator(a)
    )
    override def listTagsOfResource(a: ListTagsOfResourceRequest) = eff1(
    ...
    override def restoreTableFromBackup(a: RestoreTableFromBackupRequest) = eff1(
    ...
    override def transactWriteItems(a: TransactWriteItemsRequest) = eff1(
      client.transactWriteItems(a)
    )
    override def untagResource(a: UntagResourceRequest) = eff1(client.untagResource(a))
    override def updateContinuousBackups(a: UpdateContinuousBackupsRequest) = eff1(
