...
trait Interpreter[M[_]] { outer =>
  ...
  trait KinesisAsyncClientInterpreter
    ...
    override def deregisterStreamConsumer(a: DeregisterStreamConsumerRequest) = eff(
      _.deregisterStreamConsumer(a)
    )
    ...
    override def describeStreamConsumer(a: DescribeStreamConsumerRequest) = eff(
      _.describeStreamConsumer(a)
    )
    override def describeStreamSummary(a: DescribeStreamSummaryRequest) = eff(
      _.describeStreamSummary(a)
    )
    override def disableEnhancedMonitoring(a: DisableEnhancedMonitoringRequest) = eff(
      _.disableEnhancedMonitoring(a)
    )
    override def enableEnhancedMonitoring(a: EnableEnhancedMonitoringRequest) = eff(
      _.enableEnhancedMonitoring(a)
    )
    ...
    override def registerStreamConsumer(a: RegisterStreamConsumerRequest) = eff(
      _.registerStreamConsumer(a)
    )
    override def removeTagsFromStream(a: RemoveTagsFromStreamRequest) = eff(
      _.removeTagsFromStream(a)
    )
    override def serviceName = primitive(_.serviceName)
    override def splitShard(a: SplitShardRequest) = eff(_.splitShard(a))
    override def startStreamEncryption(a: StartStreamEncryptionRequest) = eff(
      _.startStreamEncryption(a)
    )
    override def stopStreamEncryption(a: StopStreamEncryptionRequest) = eff(
      _.stopStreamEncryption(a)
    )
  ...
  def create(client: KinesisAsyncClient): KinesisAsyncClientOp[M] = new KinesisAsyncClientOp[M] {
    ...
    override def deregisterStreamConsumer(a: DeregisterStreamConsumerRequest) = eff1(
      client.deregisterStreamConsumer(a)
    )
    ...
    override def describeStreamConsumer(a: DescribeStreamConsumerRequest) = eff1(
      client.describeStreamConsumer(a)
    )
    override def describeStreamSummary(a: DescribeStreamSummaryRequest) = eff1(
      client.describeStreamSummary(a)
    )
    override def disableEnhancedMonitoring(a: DisableEnhancedMonitoringRequest) =
      eff1(client.disableEnhancedMonitoring(a))
    override def enableEnhancedMonitoring(a: EnableEnhancedMonitoringRequest) = eff1(
      client.enableEnhancedMonitoring(a)
    )
    ...
    override def listStreamConsumers(a: ListStreamConsumersRequest) = eff1(
    ...
    override def registerStreamConsumer(a: RegisterStreamConsumerRequest) = eff1(
      client.registerStreamConsumer(a)
    )
    override def removeTagsFromStream(a: RemoveTagsFromStreamRequest) = eff1(
    ...
    override def startStreamEncryption(a: StartStreamEncryptionRequest) = eff1(
      client.startStreamEncryption(a)
    )
    override def stopStreamEncryption(a: StopStreamEncryptionRequest) = eff1(
