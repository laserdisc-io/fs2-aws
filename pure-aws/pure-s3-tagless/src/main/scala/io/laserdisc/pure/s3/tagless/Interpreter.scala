...
trait Interpreter[M[_]] { outer =>
  ...
  trait S3AsyncClientInterpreter extends S3AsyncClientOp[Kleisli[M, S3AsyncClient, *]] {
    ...
    override def abortMultipartUpload(a: AbortMultipartUploadRequest) = eff(
      _.abortMultipartUpload(a)
    )
    override def close = primitive(_.close)
    override def completeMultipartUpload(a: CompleteMultipartUploadRequest) = eff(
      _.completeMultipartUpload(a)
    )
    ...
    override def createMultipartUpload(a: CreateMultipartUploadRequest) = eff(
      _.createMultipartUpload(a)
    )
    ...
    override def deleteBucketEncryption(a: DeleteBucketEncryptionRequest) = eff(
      _.deleteBucketEncryption(a)
    )
    ...
    override def deleteBucketLifecycle(a: DeleteBucketLifecycleRequest) = eff(
      _.deleteBucketLifecycle(a)
    )
    ...
    override def deleteBucketReplication(a: DeleteBucketReplicationRequest) = eff(
      _.deleteBucketReplication(a)
    )
    ...
    override def deletePublicAccessBlock(a: DeletePublicAccessBlockRequest) = eff(
      _.deletePublicAccessBlock(a)
    )
    ...
    override def getBucketOwnershipControls(a: GetBucketOwnershipControlsRequest) = eff(
      _.getBucketOwnershipControls(a)
    )
    override def getBucketPolicy(a: GetBucketPolicyRequest) = eff(_.getBucketPolicy(a))
    override def getBucketPolicyStatus(a: GetBucketPolicyStatusRequest) = eff(
      _.getBucketPolicyStatus(a)
    )
    override def getBucketReplication(a: GetBucketReplicationRequest) = eff(
      _.getBucketReplication(a)
    )
    override def getBucketRequestPayment(a: GetBucketRequestPaymentRequest) = eff(
      _.getBucketRequestPayment(a)
    )
    ...
    override def getObjectLockConfiguration(a: GetObjectLockConfigurationRequest) = eff(
      _.getObjectLockConfiguration(a)
    )
    ...
    override def getObjectTorrent(a: GetObjectTorrentRequest, b: Path) = eff(
      _.getObjectTorrent(a, b)
    )
    override def getPublicAccessBlock(a: GetPublicAccessBlockRequest) = eff(
      _.getPublicAccessBlock(a)
    )
    ...
    override def listMultipartUploads(a: ListMultipartUploadsRequest) = eff(
      _.listMultipartUploads(a)
    )
    ...
    override def listObjectVersionsPaginator(a: ListObjectVersionsRequest) = primitive(
      _.listObjectVersionsPaginator(a)
    )
    ...
    override def listObjectsV2Paginator(a: ListObjectsV2Request) = primitive(
      _.listObjectsV2Paginator(a)
    )
    ...
    override def putBucketOwnershipControls(a: PutBucketOwnershipControlsRequest) = eff(
      _.putBucketOwnershipControls(a)
    )
    override def putBucketPolicy(a: PutBucketPolicyRequest) = eff(_.putBucketPolicy(a))
    override def putBucketReplication(a: PutBucketReplicationRequest) = eff(
      _.putBucketReplication(a)
    )
    override def putBucketRequestPayment(a: PutBucketRequestPaymentRequest) = eff(
      _.putBucketRequestPayment(a)
    )
    ...
    override def putObjectLockConfiguration(a: PutObjectLockConfigurationRequest) = eff(
      _.putObjectLockConfiguration(a)
    )
    ...
    override def putPublicAccessBlock(a: PutPublicAccessBlockRequest) = eff(
      _.putPublicAccessBlock(a)
    )
    ...
    override def writeGetObjectResponse(a: WriteGetObjectResponseRequest, b: Path) = eff(
  ...
  def create(client: S3AsyncClient): S3AsyncClientOp[M] = new S3AsyncClientOp[M] {
    ...
    // domain-specific operations are implemented in terms of `primitive`
    override def abortMultipartUpload(a: AbortMultipartUploadRequest) = eff1(
      client.abortMultipartUpload(a)
    )
    override def close = primitive1(client.close)
    override def completeMultipartUpload(a: CompleteMultipartUploadRequest) = eff1(
    ...
    override def createMultipartUpload(a: CreateMultipartUploadRequest) = eff1(
    ...
    override def deleteBucketEncryption(a: DeleteBucketEncryptionRequest) = eff1(
    ...
    override def deleteBucketLifecycle(a: DeleteBucketLifecycleRequest) = eff1(
    ...
    override def deleteBucketPolicy(a: DeleteBucketPolicyRequest) = eff1(
      client.deleteBucketPolicy(a)
    )
    override def deleteBucketReplication(a: DeleteBucketReplicationRequest) = eff1(
      client.deleteBucketReplication(a)
    )
    override def deleteBucketTagging(a: DeleteBucketTaggingRequest) = eff1(
      client.deleteBucketTagging(a)
    )
    override def deleteBucketWebsite(a: DeleteBucketWebsiteRequest) = eff1(
      client.deleteBucketWebsite(a)
    )
    override def deleteObject(a: DeleteObjectRequest) = eff1(client.deleteObject(a))
    override def deleteObjectTagging(a: DeleteObjectTaggingRequest) = eff1(
      client.deleteObjectTagging(a)
    )
    override def deleteObjects(a: DeleteObjectsRequest) = eff1(client.deleteObjects(a))
    override def deletePublicAccessBlock(a: DeletePublicAccessBlockRequest) = eff1(
    ...
    override def getBucketEncryption(a: GetBucketEncryptionRequest) = eff1(
    ...
    override def getBucketPolicyStatus(a: GetBucketPolicyStatusRequest) = eff1(
      client.getBucketPolicyStatus(a)
    )
    override def getBucketReplication(a: GetBucketReplicationRequest) = eff1(
      client.getBucketReplication(a)
    )
    override def getBucketRequestPayment(a: GetBucketRequestPaymentRequest) = eff1(
      client.getBucketRequestPayment(a)
    )
    override def getBucketTagging(a: GetBucketTaggingRequest) = eff1(client.getBucketTagging(a))
    override def getBucketVersioning(a: GetBucketVersioningRequest) = eff1(
    ...
    override def getObjectAttributes(a: GetObjectAttributesRequest) = eff1(
      client.getObjectAttributes(a)
    )
    override def getObjectLegalHold(a: GetObjectLegalHoldRequest) = eff1(
      client.getObjectLegalHold(a)
    )
    override def getObjectLockConfiguration(a: GetObjectLockConfigurationRequest) =
      eff1(client.getObjectLockConfiguration(a))
    override def getObjectRetention(a: GetObjectRetentionRequest) = eff1(
    ...
    override def getObjectTorrent(a: GetObjectTorrentRequest, b: Path) = eff1(
      client.getObjectTorrent(a, b)
    )
    override def getPublicAccessBlock(a: GetPublicAccessBlockRequest) = eff1(
    ...
    override def listMultipartUploads(a: ListMultipartUploadsRequest) = eff1(
      client.listMultipartUploads(a)
    )
    override def listMultipartUploadsPaginator(a: ListMultipartUploadsRequest) =
      primitive1(client.listMultipartUploadsPaginator(a))
    override def listObjectVersions(a: ListObjectVersionsRequest) = eff1(
    ...
    override def listObjectsV2Paginator(a: ListObjectsV2Request) = primitive1(
    ...
    override def putBucketEncryption(a: PutBucketEncryptionRequest) = eff1(
    ...
    override def putBucketReplication(a: PutBucketReplicationRequest) = eff1(
      client.putBucketReplication(a)
    )
    override def putBucketRequestPayment(a: PutBucketRequestPaymentRequest) = eff1(
      client.putBucketRequestPayment(a)
    )
    override def putBucketTagging(a: PutBucketTaggingRequest) = eff1(client.putBucketTagging(a))
    override def putBucketVersioning(a: PutBucketVersioningRequest) = eff1(
    ...
    override def putObjectLegalHold(a: PutObjectLegalHoldRequest) = eff1(
      client.putObjectLegalHold(a)
    )
    override def putObjectLockConfiguration(a: PutObjectLockConfigurationRequest) =
      eff1(client.putObjectLockConfiguration(a))
    override def putObjectRetention(a: PutObjectRetentionRequest) = eff1(
      client.putObjectRetention(a)
    )
    override def putObjectTagging(a: PutObjectTaggingRequest) = eff1(client.putObjectTagging(a))
    override def putPublicAccessBlock(a: PutPublicAccessBlockRequest) = eff1(
    ...
    override def uploadPart(a: UploadPartRequest, b: AsyncRequestBody) = eff1(
