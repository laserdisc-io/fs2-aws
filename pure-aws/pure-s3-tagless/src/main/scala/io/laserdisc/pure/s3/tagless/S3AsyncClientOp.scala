...
trait S3AsyncClientOp[F[_]] {
	...
	def createBucketMetadataConfiguration(a: CreateBucketMetadataConfigurationRequest): F[CreateBucketMetadataConfigurationResponse]
	def createBucketMetadataTableConfiguration(a: CreateBucketMetadataTableConfigurationRequest): F[CreateBucketMetadataTableConfigurationResponse]
	...
	def deleteBucketAnalyticsConfiguration(a: DeleteBucketAnalyticsConfigurationRequest): F[DeleteBucketAnalyticsConfigurationResponse]
	...
	def deleteBucketIntelligentTieringConfiguration(a: DeleteBucketIntelligentTieringConfigurationRequest): F[DeleteBucketIntelligentTieringConfigurationResponse]
	def deleteBucketInventoryConfiguration(a: DeleteBucketInventoryConfigurationRequest): F[DeleteBucketInventoryConfigurationResponse]
	def deleteBucketLifecycle(a: DeleteBucketLifecycleRequest): F[DeleteBucketLifecycleResponse]
	def deleteBucketMetadataConfiguration(a: DeleteBucketMetadataConfigurationRequest): F[DeleteBucketMetadataConfigurationResponse]
	def deleteBucketMetadataTableConfiguration(a: DeleteBucketMetadataTableConfigurationRequest): F[DeleteBucketMetadataTableConfigurationResponse]
	def deleteBucketMetricsConfiguration(a: DeleteBucketMetricsConfigurationRequest): F[DeleteBucketMetricsConfigurationResponse]
	...
	def getBucketAccelerateConfiguration(a: GetBucketAccelerateConfigurationRequest): F[GetBucketAccelerateConfigurationResponse]
	def getBucketAcl(a: GetBucketAclRequest): F[GetBucketAclResponse]
	def getBucketAnalyticsConfiguration(a: GetBucketAnalyticsConfigurationRequest): F[GetBucketAnalyticsConfigurationResponse]
	...
	def getBucketIntelligentTieringConfiguration(a: GetBucketIntelligentTieringConfigurationRequest): F[GetBucketIntelligentTieringConfigurationResponse]
	def getBucketInventoryConfiguration(a: GetBucketInventoryConfigurationRequest): F[GetBucketInventoryConfigurationResponse]
	def getBucketLifecycleConfiguration(a: GetBucketLifecycleConfigurationRequest): F[GetBucketLifecycleConfigurationResponse]
	...
	def getBucketMetadataConfiguration(a: GetBucketMetadataConfigurationRequest): F[GetBucketMetadataConfigurationResponse]
	def getBucketMetadataTableConfiguration(a: GetBucketMetadataTableConfigurationRequest): F[GetBucketMetadataTableConfigurationResponse]
	def getBucketMetricsConfiguration(a: GetBucketMetricsConfigurationRequest): F[GetBucketMetricsConfigurationResponse]
	def getBucketNotificationConfiguration(a: GetBucketNotificationConfigurationRequest): F[GetBucketNotificationConfigurationResponse]
	...
	def getObjectTorrent[ReturnT](a: GetObjectTorrentRequest, b: AsyncResponseTransformer[GetObjectTorrentResponse, ReturnT]): F[ReturnT]
	...
	def listBucketAnalyticsConfigurations(a: ListBucketAnalyticsConfigurationsRequest): F[ListBucketAnalyticsConfigurationsResponse]
	def listBucketIntelligentTieringConfigurations(a: ListBucketIntelligentTieringConfigurationsRequest): F[ListBucketIntelligentTieringConfigurationsResponse]
	def listBucketInventoryConfigurations(a: ListBucketInventoryConfigurationsRequest): F[ListBucketInventoryConfigurationsResponse]
	def listBucketMetricsConfigurations(a: ListBucketMetricsConfigurationsRequest): F[ListBucketMetricsConfigurationsResponse]
	...
	def putBucketAnalyticsConfiguration(a: PutBucketAnalyticsConfigurationRequest): F[PutBucketAnalyticsConfigurationResponse]
	...
	def putBucketIntelligentTieringConfiguration(a: PutBucketIntelligentTieringConfigurationRequest): F[PutBucketIntelligentTieringConfigurationResponse]
	def putBucketInventoryConfiguration(a: PutBucketInventoryConfigurationRequest): F[PutBucketInventoryConfigurationResponse]
	def putBucketLifecycleConfiguration(a: PutBucketLifecycleConfigurationRequest): F[PutBucketLifecycleConfigurationResponse]
	...
	def putBucketNotificationConfiguration(a: PutBucketNotificationConfigurationRequest): F[PutBucketNotificationConfigurationResponse]
