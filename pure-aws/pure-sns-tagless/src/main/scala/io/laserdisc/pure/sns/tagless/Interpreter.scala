...
trait Interpreter[M[_]] { outer =>
  ...
  trait SnsAsyncClientInterpreter extends SnsAsyncClientOp[Kleisli[M, SnsAsyncClient, *]] {
    ...
    override def createPlatformApplication(a: CreatePlatformApplicationRequest) = eff(
      _.createPlatformApplication(a)
    )
    override def createPlatformEndpoint(a: CreatePlatformEndpointRequest) = eff(
      _.createPlatformEndpoint(a)
    )
    ...
    override def deletePlatformApplication(a: DeletePlatformApplicationRequest) = eff(
      _.deletePlatformApplication(a)
    )
    ...
    override def getEndpointAttributes(a: GetEndpointAttributesRequest) = eff(
      _.getEndpointAttributes(a)
    )
    ...
    override def getSMSSandboxAccountStatus(a: GetSmsSandboxAccountStatusRequest) = eff(
      _.getSMSSandboxAccountStatus(a)
    )
    override def getSubscriptionAttributes(a: GetSubscriptionAttributesRequest) = eff(
      _.getSubscriptionAttributes(a)
    )
    ...
    override def listOriginationNumbers(a: ListOriginationNumbersRequest) = eff(
      _.listOriginationNumbers(a)
    )
    ...
    override def listPhoneNumbersOptedOut(a: ListPhoneNumbersOptedOutRequest) = eff(
      _.listPhoneNumbersOptedOut(a)
    )
    ...
    override def listPlatformApplications(a: ListPlatformApplicationsRequest) = eff(
      _.listPlatformApplications(a)
    )
    ...
    override def listSMSSandboxPhoneNumbers(a: ListSmsSandboxPhoneNumbersRequest) = eff(
      _.listSMSSandboxPhoneNumbers(a)
    )
    ...
    override def listSubscriptionsByTopic(a: ListSubscriptionsByTopicRequest) = eff(
      _.listSubscriptionsByTopic(a)
    )
    ...
    override def listSubscriptionsPaginator(a: ListSubscriptionsRequest) = primitive(
      _.listSubscriptionsPaginator(a)
    )
    ...
    override def setEndpointAttributes(a: SetEndpointAttributesRequest) = eff(
      _.setEndpointAttributes(a)
    )
    ...
    override def setSubscriptionAttributes(a: SetSubscriptionAttributesRequest) = eff(
      _.setSubscriptionAttributes(a)
    )
  ...
  def create(client: SnsAsyncClient): SnsAsyncClientOp[M] = new SnsAsyncClientOp[M] {
    ...
    override def confirmSubscription(a: ConfirmSubscriptionRequest) = eff1(
      client.confirmSubscription(a)
    )
    override def createPlatformApplication(a: CreatePlatformApplicationRequest) =
      eff1(client.createPlatformApplication(a))
    override def createPlatformEndpoint(a: CreatePlatformEndpointRequest) = eff1(
    ...
    override def getEndpointAttributes(a: GetEndpointAttributesRequest) = eff1(
    ...
    override def getTopicAttributes(a: GetTopicAttributesRequest) = eff1(
    ...
    override def listOriginationNumbers(a: ListOriginationNumbersRequest) = eff1(
    ...
    override def listPhoneNumbersOptedOut(a: ListPhoneNumbersOptedOutRequest) = eff1(
      client.listPhoneNumbersOptedOut(a)
    )
    override def listPhoneNumbersOptedOutPaginator = primitive1(
    ...
    override def listPlatformApplications(a: ListPlatformApplicationsRequest) = eff1(
      client.listPlatformApplications(a)
    )
    override def listPlatformApplicationsPaginator = primitive1(
      client.listPlatformApplicationsPaginator
    )
    override def listPlatformApplicationsPaginator(a: ListPlatformApplicationsRequest) =
      primitive1(client.listPlatformApplicationsPaginator(a))
    override def listSMSSandboxPhoneNumbers(a: ListSmsSandboxPhoneNumbersRequest) =
      eff1(client.listSMSSandboxPhoneNumbers(a))
    override def listSMSSandboxPhoneNumbersPaginator(a: ListSmsSandboxPhoneNumbersRequest) =
    ...
    override def listSubscriptionsByTopic(a: ListSubscriptionsByTopicRequest) = eff1(
      client.listSubscriptionsByTopic(a)
    )
    override def listSubscriptionsByTopicPaginator(a: ListSubscriptionsByTopicRequest) =
    ...
    override def listTopicsPaginator(a: ListTopicsRequest) = primitive1(
    ...
    override def setEndpointAttributes(a: SetEndpointAttributesRequest) = eff1(
    ...
    override def setTopicAttributes(a: SetTopicAttributesRequest) = eff1(
    ...
    override def verifySMSSandboxPhoneNumber(a: VerifySmsSandboxPhoneNumberRequest) =
      eff1(client.verifySMSSandboxPhoneNumber(a))
